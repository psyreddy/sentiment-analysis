...
TRAIN_FEATURES_FILE = './dataset/train-feats.npy'
TRAIN_LABELS_FILE = './dataset/train-labels.txt'
TEST_FEATURES_FILE = './dataset/test-feats.npy'
CLASSIFIER = 'SVM'
MODEL_FILE = './models/cnn-feats-%s.pkl' % CLASSIFIER
TRAIN = True
C = 1
MAX_ITER = 1000
...
if TRAIN:
    ...
    utils.save_results_to_csv(results, './results/cnn-feats-svm-linear-%.2f-%d.csv' % (C, MAX_ITER))
